...
# The `selectable-items` Custom Element
...
|||||
|-|-|-|-|
|Package size, **verbose**:|~4kb|Package size, **minified**:|~3kb|
...
## Links
### Demo:
https://catapart.github.io/magnitce-selectable-items
### Documentation:
https://catapart.github.io/magnitce-selectable-items/docs
### Automated Testing:
https://catapart.github.io/magnitce-selectable-items/tests.html
